...
<header>
  ...
  "Jus de pommes"
                ...
                const ingredients_sans_doublons = [...new Set(ingredients)];
                const ingredients_a_eviter = [];

                for (let i = 0; i < ingredients_sans_doublons.length; i++) {
                    ingredients_a_eviter.push("pas de " + ingredients_sans_doublons[i]);
                }

                //console.log(ingredients_a_eviter);
                array = drinks.concat(ingredients_sans_doublons);
                array = array.concat(ingredients_a_eviter);
